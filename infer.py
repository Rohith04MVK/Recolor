...
from utils import exists, lab_to_rgb, str2bool


def check_opts(opts):
    exists(f"{opts.checkpoint_dir}/res18-unet.pt", "Resunet is missing or has a differnt name")
    exists(f"{opts.checkpoint_dir}/final_model_weights.pt", "Final model is missing or has a differnt name")
